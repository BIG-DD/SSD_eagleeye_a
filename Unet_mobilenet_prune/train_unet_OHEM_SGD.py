...
def main(config, resume):
    ...
    lr_warmup = GradualWarmupScheduler(optimizer, multiplier=1, total_epoch=10, after_scheduler=lr_scheduler)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./config/config_Unet_Adata_OHEM_SGD.json', type=str,
