...
# #
# from models.backbonds.ResNet import ResNet as backbones
# #------------------------------------------------------------------------------
# #   DecoderBlock
# #------------------------------------------------------------------------------
...
# 	model = UNetPlus(backbone="resnet18", num_classes=2)
# 	print(model)
# 	from torchsummary import summary
# 	model = model.to("cuda")
# 	summary(model, (3, 256, 256))
# 	onnx_path = '/media/z590/G/Pytorch/Segmentation-PyTorch-master/workspace/mobilenetv2.onnx'
# 	model = model.to('cpu')
...
if __name__ == "__main__":
	model = ResNet34UnetPlus(num_class=2)
	print(model)
	from torchsummary import summary
	model = model.to("cuda")
	# summary(model, (1, 3, 256, 256))
	onnx_path = '/media/z590/G/Pytorch/Segmentation-PyTorch-master/workspace/ResNet34UnetPlus.onnx'
	model = model.to('cpu')
	pth2onnx(model, onnx_path, 256, 256)