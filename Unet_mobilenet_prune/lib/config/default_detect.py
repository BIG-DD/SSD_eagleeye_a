...
# yolov4_Bottleneck_tiny, yolov4_tiny,yolov4_tiny_origin,yolov4_tiny_mask, yolov4_tiny_mask_advance,yolov4_tiny_mask_advance_1branch
_C.MODEL.NAME = 'yolov4_tiny_mask_advance_1branch'
...
_C.MODEL.IMAGE_SIZE = [512, 512]  # height,width ex: 192, 256
...
root = '/media/z590/D/PublicDataSet/context-based-parking-slot-detect/YOLOP/publick_train_dataset/'# '/media/z590/D/PublicDataSet/VOCdevkit/VOC2012/YOLOP/'
...
_C.TRAIN.SPARSITY_FACTOR = 0.0001  # 稀疏化因子  # 1e-4 <= sr <= 1e-4
