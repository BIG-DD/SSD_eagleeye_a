...
_C.LOG_DIR = 'D:/project/python/yolop/runs/' #train result
_C.GPUS = (0)
_C.WORKERS = 0 # win set 0, and ubuntu set 8
_C.PIN_MEMORY = False
...
_C.MODEL.IMAGE_SIZE = [256, 256]  # height,width ex: 192, 256
...
root = 'D:/project/python/abc/data/park_line/test/A/'# '/media/z590/D/PublicDataSet/VOCdevkit/VOC2012/YOLOP/'  dataset_path
...
_C.DATASET.TEST_SET = 'val' #'val'
_C.DATASET.DATA_FORMAT = 'jpg'
_C.DATASET.SELECT_DATA = False
_C.DATASET.ORG_IMG_SIZE = [512, 512]#[720, 1280]   #
