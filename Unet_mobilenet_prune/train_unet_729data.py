...
from torch.optim.lr_scheduler import StepLR, ExponentialLR, GradualWarmupScheduler, CosineAnnealingWarmRestarts, \
    CosineAnnealingLR
# ------------------------------------------------------------------------------
#   Get instance
# ------------------------------------------------------------------------------
...
def main(config, resume):
    ...
    lr_warmup = GradualWarmupScheduler(optimizer, multiplier=1, total_epoch=5, after_scheduler=lr_scheduler)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./config/config_UNet_mobilenet_prune.json', type=str,
