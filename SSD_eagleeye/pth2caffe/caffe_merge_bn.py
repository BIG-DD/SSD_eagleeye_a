...
# from pth2caffe.Caffe import caffe_net

# from pth2caffe.Caffe import caffe_pb2 as cp
caffe.set_mode_cpu()
...
if __name__ == '__main__':
    args = parse_args()
    cb = ConvertBnn(args.caffe_config_filename, args.caffe_weights_filename, args.caffe_without_bn_config_filename,
                    args.caffe_without_bn_weight_filename)
    cb.convert()
