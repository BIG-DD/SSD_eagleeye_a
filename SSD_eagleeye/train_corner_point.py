...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '2012_train_conf0.7_coner_point.txt'
    val_annotation_path     = '2012_val_conf0.7_coner_point.txt'
    model_path = ''
    #------------------------------------------------------#
    #   输入的shape大小
    #------------------------------------------------------#
    ...
    #---------------------------------------------#
    backbone = "MobileNetV2_4_2"   # MobileNetV2_4_2
    pretrained = False
    batch_size = 64  # 64
    num_workers = 16  # 16
    start_epoch = 0
