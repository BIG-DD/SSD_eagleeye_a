...
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
VOCdevkit_path  = '/media/byd/A264AC9264AC6AAD/DataSet/conf0.7_corner/'
det_type = 'conf0.7_coner_point'
...
def convert_annotation(year, image_id, list_file):
    ...
    for obj in root.iter('object'):
        ...
        if cls not in classes or int(difficult) == 1:
            print('error:'+cls+' not in classes file is : '+image_id)
            continue
...
if __name__ == "__main__":
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for year, image_set in VOCdevkit_sets:
            ...
            list_file = open('%s_%s_%s.txt'%(year, image_set, det_type), 'w', encoding='utf-8')
